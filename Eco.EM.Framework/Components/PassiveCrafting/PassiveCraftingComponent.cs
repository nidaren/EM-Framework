...
namespace Eco.EM.Framework.Components
{
    ...
    public class PassiveCraftingComponent : WorldObjectComponent
    {
        ...
        protected virtual Result Craft() 
        {
            ...
            foreach (var e in Outputs) { changes.AddItemsNonUnique(e.Item1.GetType(), (int)Math.Ceiling(e.Item2)); } //Changed from AddItems to new method AddItemsNonUnique. AddItems no longer works 
